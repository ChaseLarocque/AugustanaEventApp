...
public class AddEventListener implements View.OnClickListener {
     ...
     * If the continue button is clicked, it will go to another dialog or close the dialog if it is
     * at the last dialog. Clicking if after selecting the date will take the user to the select
     * time dialog, then clicking it after selecting a time will take the user to the event
     * details dialog and then clicking it after entering event details will close the dialog
     * @param addEvents
     */
